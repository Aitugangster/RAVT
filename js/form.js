...
function fosInputSend() {
    ...
    if(t1 == ''){
        $('input[name="name"]').closest('.input-block__item').css({'border-bottom':'1px solid red'})
        err = 1;
    } else {
        $('input[name="name"]').closest('.input-block__item').css({'border-bottom':'1px solid green'})
    }
    if(t2 == ''){
        $('input[name="phone"]').closest('.input-block__item').css({'border-bottom':'1px solid red'})
        err = 1;
    } else {
        $('input[name="phone"]').closest('.input-block__item').css({'border-bottom':'1px solid green'})
    }
    if(t3 == ''){
        $('textarea[name="text"]').closest('.input-block__item').css({'border-bottom':'1px solid red'})
        err = 1;
    } else {
        $('textarea[name="text"]').closest('.input-block__item').css({'border-bottom':'1px solid green'})
    }
...
function fosPopupSend() {
    ...
    if(t1 == ''){
        $('input[name="name"]').closest('.popup-block__item').css({'border-bottom':'1px solid red'})
        err = 1;
    } else {
        $('input[name="name"]').closest('.popup-block__item').css({'border-bottom':'1px solid green'})
    }
    if(t2 == ''){
        $('input[name="phone"]').closest('.popup-block__item').css({'border-bottom':'1px solid red'})
        err = 1;
    } else {
        $('input[name="phone"]').closest('.popup-block__item').css({'border-bottom':'1px solid green'})
    }
    if(t3 == ''){
        $('textarea[name="text"]').closest('.popup-block__item').css({'border-bottom':'1px solid red'})
        err = 1;
    } else {
